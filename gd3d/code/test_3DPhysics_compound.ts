...
class test_3DPhysics_compound implements IState {
    ...
    attachMesh(tran:gd3d.framework.transform, mat: gd3d.framework.material, meshName : string , needReset = false) : gd3d.framework.meshRenderer{
